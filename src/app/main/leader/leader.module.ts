...
@NgModule({
    ...
    imports: [
        ...
        RouterModule.forChild([
            ...
            {
                path: 'course',
                loadChildren: () => import('./manage/course/course.module').then(m => m.CourseModule),
                data: {
            ...
            },
            {
                ...
                loadChildren: () => import('./manage/assignment-internship/assignment-internship.module').then(m => m.AssignmentInternshipModule),
                data: {
          ...
          {
            path: 'internship',
            loadChildren: () => import('./manage/internship/internship.module').then(m => m.InternshipModule),
            data: {
          ...
          },
          {
            ...
            loadChildren: () => import('./manage/class-internship/internship-class.module').then(m => m.ClassInternshipModule),
            data: {
