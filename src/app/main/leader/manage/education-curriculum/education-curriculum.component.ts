...
import { WebsiteInfoRef } from '../../../entities/website-info-ref';
declare var $: any;

@Component({
  selector: 'app-education-curriculum',
  templateUrl: './education-curriculum.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EducationCurriculumComponent extends Grid implements OnInit {
