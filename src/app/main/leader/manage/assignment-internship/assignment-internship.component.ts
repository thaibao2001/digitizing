...
@Component({
  selector: 'app-assignment-internship',
  templateUrl: './assignment-internship.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AssignmentInternshipComponent extends Grid implements OnInit {
  ...
  public constructor(injector: Injector, private confirmationService: ConfirmationService) {
    super(injector);
