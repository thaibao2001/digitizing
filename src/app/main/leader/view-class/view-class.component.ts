...
export class ViewClassComponent extends Grid implements OnInit {
  ...
  public departments: any = [{ id: 1, name: 'Tất cả'}, { id: 1, name: 'content 1'}];

  public specialized: any = [{ id: 1, name: 'Tất cả'}, { id: 1, name: 'content 1'}];
  ...
  public ngOnInit() {
    this.website_tag = new WebsiteTag();
      ...
      this.data = [{
          id: 1,
          name: '101191A',
        specialized: 'Công nghệ web',
        homeroom: 'Nguyễn Văn Quyết',
      },
      {
          id: 2,
          name: '101191',
